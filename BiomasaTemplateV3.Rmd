...
This document summarises forest inventory data collected by the *RAINFOR network (www.rainfor.org)*.  The plots (plotviews) in this report conform to the following criteria: *multiple census plots*, *minimum diameter of 100mm*, *plot area greater than 0.2 ha*.
...
colnames(Table2friendly )<-c("Census number", "Country","Plot","Plot area", "Latitude","Longitude","Census date","AGB","Stem number")
...
**Figure 3. Map of the rate of change of aboveground biomass (Mg/ha/a)**
