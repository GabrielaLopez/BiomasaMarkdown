...
<br>Aboveground biomass change was estimated as the difference in AGB between the first and last census, divided by the time elapsed (Figure 3). In Figure 3 the rate of biomass change over time is indicated by colour, and the size of the marker represents the AGB weighted mean.</br>
